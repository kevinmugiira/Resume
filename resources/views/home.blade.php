...
<html lang="en-US">
  <head>
    ...
    <link href="{{asset('asset/css/font-awesome/css/all.min.css')}}?ver=1.2.1" rel="stylesheet">
    <link href="{{asset('asset/css/mdb.min.css')}}?ver=1.2.1" rel="stylesheet">
    <link href="{{asset('asset/css/aos.css')}}?ver=1.2.1" rel="stylesheet">
    <link href="{{asset('asset/css/main.css')}}?ver=1.2.1" rel="stylesheet">
    <noscript>
      <style type="text/css">
        [data-aos] {
            opacity: 1 !important;
...
<div class="resume-container">
  <div class="shadow-1-strong bg-white my-5" id="intro">
    <div class="bg-info text-white">
      <div class="cover bg-image"><img src="{{asset('asset/images/header-background.jpg')}}"/>
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);backdrop-filter: blur(2px);">
          <div class="text-center p-5">
            <div class="avatar p-1"><img class="img-thumbnail shadow-2-strong" src="{{asset('asset/images/kevinmugiira.jpg')}}" width="160" height="160"/></div>
            <div class="header-bio mt-3">
              <div data-aos="zoom-in" data-aos-delay="0">
                <h2 class="h1">Kevin Mugiira</h2>
              ...
              <div class="header-social mb-3 d-print-none" data-aos="zoom-in" data-aos-delay="200">
                <nav role="navigation">
                  <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item"><a class="nav-link" href="https://www.facebook.com/veksohn.mon/" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="https://www.instagram.com/kevin_mugiira/" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="https://github.com/kevinmugiira" title="Github"><i class="fab fa-github"></i><span class="menu-title sr-only">Github</span></a>
                    </li>
                  </ul>
                </nav>
              </div>
    ...
    <div class="about-section">
      <div class="row">
        <div class="col-md-6">
          ...
          <p>Hello! I’m Kevin Mugiira. I am passionate about UI/UX design and Web Design. I am a skilled <strong>front-end developer</strong> and master of <strong>Back-end developer </strong>with skills in image design tools such as Gimp. I am a quick learner and a team worker that gets the job done.</p>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="mb-3"><span class="fw-bolder">PHP</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-info" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300" data-aos-anchor=".skills-section" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">Expert</div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-3"><span class="fw-bolder">Gimp</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="400" data-aos-anchor=".skills-section" style="width: 80%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">Professional</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">Android Studio</span>
            <div class="progress my-2 rounded" style="height: 20px">
          ...
          <div class="mb-3"><span class="fw-bolder">JQuery</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="500" data-aos-anchor=".skills-section" style="width: 65%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">Beginner</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">Daft</span>
            <div class="progress my-2 rounded" style="height: 20px">
      ...
      <div class="timeline">
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="0">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">FullStack Developer <span class="text-muted h6">at Net-co</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">Dec, 2021 - Present</div>
            <div>Leverage the Laravel framework to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy such as Marketing and Human Resource to foster collaborative thinking to further the overall value proposition.</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="200">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Content Developer <span class="text-muted h6">at Zen Bubbles</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">March, 2021 - July, 2021</div>
            <div>Creation of marketing content for social media platforms to override the digital divide with additional clickthroughs from Social Media platforms. Digital Marketing utilisation for business growth will close the loop on focusing solely on high-end mainstream marketing.</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="400">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Junior Web Developer <span class="text-muted h6">at Kaskara</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">Jan, 2020 - June, 2020</div>
            <div>Business management from a single point. Implementation in real-time with multiple access points. Organically growing the holistic business view and integrating that into co-orporate processes mainly finance through software development utilisation .</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="education-section">
      ...
      <div class="timeline">
        <div class="timeline-card timeline-card-success" data-aos="fade-in" data-aos-delay="0">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Bachelors of Science in Information Technology <span class="text-muted h6">from Kenyatta University</span>          </div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">2017 - present</div>
            <div>Leverage Information Technology to provide a robust synopsis for high level overviews and provide business solutions through programming and development.</div>
          </div>
        </div>
        ...
        <div class="timeline-card timeline-card-success" data-aos="fade-in" data-aos-delay="400">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Laravel Enthusiast <span class="text-muted h6"></span>          </div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">2018 - present</div>
            <div>Generated content for web development has never been so easy. Framework leveraging for real-time development is the future for web based software.</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="shadow-1-strong bg-white my-5 p-5 d-print-none" id="portfolio">
    <div class="portfolio-section">
      ...
      <div class="row g-0">
        <div class="col-md-6"><a href="https://dribbble.com/" target="_blank"><img class="img-fluid" src="{{asset('asset/images/project-1.jpg')}}" width="800" height="500"/></a></div>
      ...
      <div class="row g-0 portfolio-reverse">
        <div class="col-md-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
          <div class="m-4 mt-md-2 text-end">
            <p class="text-teal text-small">Graphic Design / PHP / HTML / CSS / JavaScript </p>
            <h3>Land Management Website Design</h3>
            <p class="text-muted">Web design for popular Land management company based in Ruiru Kenya. Collaboration of with back-end and front-end developement for finished product.</p>
          </div>
        </div>
        <div class="col-md-6"><a href="https://www.behance.net/" target="_blank"><img class="img-fluid" src="{{asset('asset/images/project-2.jpg')}}" width="800" height="500"/></a></div>
      </div>
      <div class="row g-0">
        <div class="col-md-6"><a href="https://dribbble.com/" target="_blank"><img class="img-fluid" src="{{asset('asset/images/project-3.jpg')}}" width="800" height="500"/></a></div>
        <div class="col-md-6 d-flex align-items-center" data-aos="fade-left" data-aos-delay="100">
          <div class="m-4 mt-md-2">
            <p class="text-teal text-small">Frontend / PHP / HTML / CSS / JavaScript</p>
            <h3>E-Commerce Website</h3>
            <p class="text-muted">Built high performance  website for an E-commerce Portal. Worked with back-end team to timely deliver codebase in HTML, CSS, PHP, and modern JavaScript.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="d-flex"><i class="text-secondary fas fa-quote-left"></i>
            <p class="lead mx-2" data-aos="fade-left" data-aos-delay="100">Kevin displays exemplary professionalism and is able to take on challenges. He learns quickly and is an asset to any team.</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="d-flex mb-2">
          ...
          <div class="d-flex"><i class="text-secondary fas fa-quote-left"></i>
            <p class="lead mx-2" data-aos="fade-left" data-aos-delay="100">Kevin is a great co-worker and problem solver. He is quick to extend his helping hand and makes a good team player.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="contant-section">
      ...
      <div class="row mb-4">
        <div class="col-md-5" data-aos="fade-left" data-aos-delay="200">
          <div class="mt-1">
            <div class="h6"><i class="fas fa-phone pe-2 text-muted" style="width:24px;opacity:0.85;"></i> 0710-955-090</div>
            <div class="h6"><i class="far fa-envelope pe-2 text-muted" style="width:24px;opacity:0.85;"></i> kevinm@net-co.online</div>
          </div>
  ...
  <button class="btn btn-info btn-block mb-4" type="submit">Send</button>
        ...
        <div class="col-md-7 d-print-none" data-aos="zoom-in" data-aos-delay="100"><iframe src="https://maps.google.com/maps?q=Ruiru%20Kenya&t=&z=13&ie=UTF8&iwloc=&output=embed" width="500" height="400" style="border:0;width:100%;" allowfullscreen="" loading="lazy"></iframe></div>
      </div>
    </div>
  </div>
</div></div>
    ...
    <footer class="pt-4 pb-4 text-muted text-center d-print-none">
      <div class="container">
        <div class="my-3">
          <div class="h4">Kevin Mugiira</div>
        ...
        <div class="text-small">
          <div class="mb-1">&copy; Kevin Mugiira Resume. All rights reserved.</div>
          <div>Design - <a href="https://kevinm.com/" target="_blank">Kevinm Designs</a></div>
        </div>
      </div>
    </footer>
    <script src="{{asset('asset/scripts/mdb.min.js')}}?ver=1.2.1"></script>
    <script src="{{asset('asset/scripts/aos.js')}}?ver=1.2.1"></script>
    <script src="{{asset('asset/scripts/main.js')}}?ver=1.2.1"></script>
  </body>
</html>
